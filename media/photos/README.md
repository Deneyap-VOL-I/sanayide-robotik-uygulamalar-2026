...
Bu klasör, rapor ve sunumlarda kullanılabilecek proje görsellerini tutar.
...
- Tarihli `.jpeg` dosyaları mevcut ham/proje fotoğrafları olarak kök dizinde bırakılmıştır.
- Şeffaf arka planlı model renderları dosya adında `_transparent_bg`, opak arka planlı renderlar `_solid_bg` ekiyle tutulur.
- AI/render riski taşıyan veya kaynağı belirsiz görseller doğrudan teknik yeterlilik raporuna eklenmemelidir.
